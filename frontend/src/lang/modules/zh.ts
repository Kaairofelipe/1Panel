...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            sharedMemoryAcrossssConversations: '跨会话共享记忆',
            asyncMode: '异步模式',
            ackText: '确认消息',
    ...
    setting: {
        ...
        mfaIntervalHelper:
            '修改刷新时间后，请重新扫描或手动添加密钥信息！\n部分验证器仅支持 30 秒刷新时间（如 Google/Microsssoft Authenticator），请确认兼容性。',
        passkey: '通行密钥',
        passkeyManage: '管理',
    ...
    app: {
        ...
        defaultWebDomainHelper: '如果应用端口为 8080，则跳转地址为 http(s)://默认访问地址:8080',
