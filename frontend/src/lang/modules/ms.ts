...
const message = {
    commons: {
        ...
        loadingText: {
            Upgrading: 'Peningkatan system, sila tunggu...',
            Restarting: 'Memulakan semula system, sila tunggu...',
        ...
        msg: {
            ...
            closeDrawerHelper: 'System mungkin tidak menyimpan perubahan yang anda buat. Adakah anda ingin teruskan?',
            deleteSuccess: 'Berjaya diparam',
    ...
    home: {
        ...
        systemInfo: 'Maklumat system',
        hostname: 'Nama hos',
        platformVersion: 'System pengendalian',
    ...
    database: {
        manage: 'Pengurusan',
        deleteBackupHelper: 'Param sandaran pangkalan data secara serentak',
        delete: 'Operasi param tidak boleh diundurkan, sila masukkan "',
        ...
        usedMemoryRss: 'Saiz memori yang diminta daripada system pengendalian.',
        ...
        restartNowHelper1:
            'Anda perlu memulakan semula system selepas perubahan konfigurasi berkuat kuasa. Jika data anda perlu dipelihara, lakukan operasi simpan terlebih dahulu.',
        restartNowHelper: 'Perubahan ini hanya akan berkuat kuasa selepas system dimulakan semula.',
    ...
    aiTools: {
        agents: {
            ...
            hermesChatDeleteConfirm: 'Param sesi {0}?',
            hermesChatDeleteSuccess: 'Sesi berjaya diparam',
            weixin: 'Weixin',
            qq: 'QQ',
            wecom: 'WeCom',
            dingtalk: 'DingTalk',
            ...
            sharedMemoryAcrosssConversations: 'Kongsi memori merentas perbualan',
            asyncMode: 'Mod async',
            ...
            channelDeleteConfirm: 'Param konfigurasi saluran {0}?',
            deleteAndRestartSuccess: 'Berjaya diparam. Bekas sedang dimulakan semula secara automatik.',
        ...
        gpu: {
            gpu: 'Pemantauan GPU',
            gpuHelper: 'System tidak mengesan arahan NVIDIA-SMI atau XPU-SMI. Sila periksa dan cuba lagi!',
    ...
    container: {
        ...
        delInsecure: 'Paramkan pendaftaran tidak selamat',
        delInsecureHelper:
        ...
        deleteFile: 'Param fail',
        deleteComposeHelper:
            'Param semua fail berkaitan komposisi kontena, termasuk fail konfigurasi dan fail berterusan. Sila berhati-hati!',
        deleteCompose: 'Param komposisi ini.',
        composeDirectory: 'Direktori',
        template: 'Template',
        composeTemplatee: 'Template Compose | Template Compose',
        content: 'Kandungan',
    ...
    cronjob: {
        ...
        log: 'Log sandaran',
        logHelper: 'Log system sandaran',
        ogHelper1: '1. Log System 1Panel ',
        ...
        cleanRemoteData: 'Param data jarak jauh',
        cleanDataHelper: 'Param fail sandaran yang dijana semasa tugas ini.',
        ...
        library: {
            ...
            syncHelper: 'Akan menyelaraskan pustaka skrip system. Operasi ini hanya melibatkan skrip system. Teruskan?',
        },
        nextTime: '5 pelaksanaan seterusnya',
        logHelper1: '1. Log system 1Panel',
    ...
    terminal: {
        ...
        localHelper: 'Nama tempatan hanya digunakan untuk pengenalan system tempatan.',
        ...
        fontFamilySupportHelper:
            'Pilih atau masukkan fon. Sama ada berkesan bergantung pada sama ada fon tersebut dipasang pada system pelayar; jika tiada, ia akan fallback secara automatik. Jika kosong, fon lalai akan digunakan.',
        ...
        aiPrefixAsciiVisible:
            'Hanya aksara ASCII yang kelihatan disokong. Ruang, aksara CJK dan symbol lebar penuh tidak dibenarkan.',
    ...
    toolbox: {
        ...
        swap: {
            ...
            swapHelper2:
                'Sebelum mencipta fail swap, pastikan cakera system mempunyai ruang yang mencukupi, kerana saiz fail swap akan menggunakan ruang cakera yang bersamaan;',
            swapHelper3:
                'Swap boleh membantu mengurangkan tekanan memori, tetapi ia hanya alternatif. Kebergantungan berlebihan pada swap boleh menyebabkan penurunan prestasi system. Disarankan untuk mengutamaken peningkatan memori atau pengoptimuman penggunaan memori aplikasi;',
            swapHelper4:
                'Disarankan untuk memantau penggunaan swap secara berkala bagi memastikan operasi system berjalan dengan normal.',
            swapDeleteHelper:
                'Operasi ini akan membuang partition Swap {0}. Atas sebab keselamatan system, fail yang sepadan tidak akan diparamkan secara automatik. Jika pemadaman diperlukan, sila lakukan secara manual!',
        ...
        device: {
            ...
            dnsAlert:
                'Perhatian! Mengubah konfigurasi fail /etc/resolv.conf akan mengembalikan fail ke nilai lalai selepas system dimulakan semula.',
            dnsHelper1:
            ...
            hostname: 'Nama hos',
            passwd: 'Kata laluan system',
            passwdHelper: 'Aksara input tidak boleh termasuk $ dan &',
            timeZone: 'Zon waktu',
            localTime: 'Waktu pelayan',
            timeZoneChangeHelper: 'Mengubah zon waktu system memerlukan memulakan semula perkhidmatan. Teruskan?',
            timeZoneHelper:
                'Jika anda tidak memasang arahan "timedatectl", anda mungkin tidak dapat mengubah zon waktu kerana system menggunakan arahan itu untuk mengubah zon waktu.',
            timeZoneCN: 'Beijing',
            ...
            syncSiteHelper: 'Gunakan {0} untuk penyegerakan masa system. Teruskan?',
        },
        fail2ban: {
        ...
        ftp: {
            ...
            dirSystem:
                'Direktori ini dikhaskan untuk system. Pengubahsuaian mungkin menyebabkan system rosak, sila ubah dan cuba lagi!',
        ...
        clam: {
            ...
            removeRecord: 'Param fail laporan',
            noRecords: 'Klik butang "Picu" untuk memulakan imbasan dan anda akan melihat rekod di sini.',
            removeInfected: 'Param fail virus',
            removeInfectedHelper:
                'Param fail virus yang dikesan semasa tugas untuk memastikan keselamatan pelayan dan operasi normal.',
            clamCreate: 'Cipta peraturan imbasan',
            infectedStrategy: 'Strategi fail dijangkiti',
            removeHelper: 'Param fail virus, pilih dengan berhati-hati!',
            move: 'Pindah',
    ...
    file: {
        ...
        aiSearchResultsSection: 'Hasil analysis',
        ...
        aiSearchMeta: 'Item untuk analysis: {0} | Tempoh {1} | Token {2}',
        ...
        deleteHelper:
            'Adakah anda pasti mahu memadam fail berikut? Secara lalai, ia akan masuk ke tong kitar semula selepas diparamkan',
        fileHelper: 'Nota:\n1. Keputusan carian tidak boleh diisih.\n2. Folder tidak boleh diisih mengikut saiz.',
        forceDeleteHelper: 'Paramkan fail secara kekal (tanpa masuk ke tong kitar semula, param terus)',
        recycleBin: 'Tong kitar semula',
        sourcePath: 'Laluan asal',
        deleteTime: 'Masa param',
        ...
        clashDeleteAlert: 'Folder "Tong Kitar Semula" tidak boleh diparamkan',
        ...
        panelInstallDir: 'Direktori pemasangan 1Panel tidak boleh diparamkan',
        ...
        deleteSourceFile: 'Param Fail Asal',
    ...
    ssh: {
        ...
        confFileOrderHelper:
            'Gunakan dropdown untuk tukar fail konfigurasi dan terus edit/simpan; tetapan berkuat kuasa mengikut turutan muat, nilai yang dimuat dahulu diutamaken.',
    ...
    setting: {
        ...
        watermarkGap: 'Jarak',
        watermarkCloseHelper: 'Adakah anda pasti ingin mematikan tetapan tanda air system?',
        watermarkOpenHelper: 'Adakah anda pasti ingin menyimpan tetapan tanda air system semasa?',
        title: 'Alias panel',
        ...
        regionTip: 'Wilayah operasi mempengaruhi sumber kemas kini system serta alamat muat turun pakej pemasangan.',
        ...
        proxyHelper2: 'Kemas kini system dan semaken maklumat kemas kini (Edisi Pro sahaja)',
        proxyHelper4: 'Permintaan rangkaian seperti tarikan imej Docker akan melalui pelayan proksi (Edisi Pro sahaja)',
        proxyHelper3: 'Pengesahan dan penyelarasan lesen system',
        proxyHelper5: 'Muat turun dan penyegerakan bersepadu untuk pustaka skrip system (ciri Edisi Pro)',
        ...
        timeZoneHelper:
            'Pengubahan zon waktu bergantung pada perkhidmatan system timedatectl. Berkuat kuasa selepas mulakan semula perkhidmatan 1Panel.',
        timeZoneCN: 'Beijing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        syncSite: 'Ntp Server',
        syncSiteHelper:
            'Operasi ini akan menggunakan {0} sebagai sumber untuk penyegerakan masa system. Adakah anda mahu meneruskan?',
        ...
        passkeyPrereqBrowserDetailWebAuthnUnavailable:
            'Gunakan pelayar system dan pastikan panel dibuka melalui HTTPS dengan domain yang telah diikat.',
        passkeyPrereqBrowserDetailPlatformCapabilityUnavailable:
            'Persekitaran ini tidak boleh menggunakan pengesahan peranti. Cuba pelayar system pada versi OS yang lebih baharu.',
        ...
        passkeyPrereqBrowserDetailDetectFailed:
            'Pengesanan gagal. Muat semula dan cuba lagi, atau tukar ke pelayar system.',
        ...
        passkeyDeleteConfirm: 'Selepas diparam, passkey ini tidak boleh digunakan untuk log masuk. Teruskan?',
        ...
        panelSSL: 'Panel SSL',
        unBindDomainHelper:
            'Tindakan membuka ikatan nama domain boleh menyebabkan ketidakamanan system. Adakah anda mahu meneruskan?',
        ...
        unAllowIPsWarning:
            'Membenarkan IP kosong akan membolehkan semua IP mengakses system, yang boleh menyebabkan ketidakamanan system. Adakah anda mahu meneruskan?',
        allowIPsHelper:
        ...
        mfaIntervalHelper:
            'Selepas mengubah selang penyegaran, imbas semula atau tambahkan kunci rahsia secara manual.\nSesetengah aplikasi pengesah hanya menyokong selang 30 saat (contohnya, Google/Microssoft Authenticator).',
        mfaAlert:
        ...
        noAuthSettingHelper:
            'Apabila pengguna tidak log masuk dengan pintu masuk keselamatan yang ditentukan, atau tidak mengakses panel dari IP atau nama domain yang ditentukan, response ini boleh menyembunyikan ciri panel.',
        responseeSetting: 'Tetapan response',
        ...
        deleteHelper:
            'Semua fail snapshot termasuk yang ada dalam akaun sandaran pihak ketiga akan diparamkan. Adakah anda mahu meneruskan?',
        status: 'Status snapshot',
        ignoreRule: 'Aturan abaikan',
        editIgnoreRule: 'Sunting aturan abaikan',
        ignoreHelper:
            'Aturan ini akan digunakan untuk memampatkan dan menyandarkan direktori data 1Panel semasa membuat snapshot. Secara lalai, fail socket diabaikan.',
        ignoreHelper1: 'Satu per baris. Contoh,\n*.log\n/opt/1panel/cache',
        panelInfo: 'Tulis maklumat asas 1Panel',
        panelBin: 'Sandarkan fail system 1Panel',
    ...
    clean: {
        ...
        system: 'Fail Sampah System',
        systemHelper: 'Fail sementara dijana semasa snapshot, naik taraf, dan proses lain',
        panelOriginal: 'Fail sandaran sebelum pemulihan snapshot system',
        upgrade: 'Fail sandaran naik taraf system',
        agentPackages: 'Pakej naik taraf/pemasangan nod anak versi sejarah',
        upgradeHelper: '(Disarankan untuk mengekalkan sandaran peningkatan terbaru untuk pemulihan system)',
        rollback: 'Fail sandaran sebelum pemulihan',
        backup: 'Sandaran System',
        backupHelper: 'Fail sandaran tidak dikaitkan dengan akaun sandaran tempatan',
        unknownBackup: 'Sandaran System',
        ...
        uploadHelper: 'Fail sementara dimuat naik dari senarai sandaran system',
        download: 'Fail Muat Turun Sementara',
        downloadHelper: 'Fail sementara dimuat turun dari akaun sandaran pihak ketiga oleh system',
        directory: 'Direktori',
        systemLog: 'Fail log',
        systemLogHelper: 'Log system, log tugas, fail log laman web',
        ...
        snapshot: 'Fail sementara syot kilat system',
    },
    app: {
        ...
        forceDelete: 'Param Paksa',
        forceDeleteHelper: 'Param paksa akan mengabaikan ralat semasa proses pemadaman dan akhirnya memadam metadata.',
        deleteBackup: 'Param sandaran',
        deleteBackupHelper: 'Juga param sandaran aplikasi',
        deleteDB: 'Param pangkalan data',
        deleteDBHelper: 'Juga param pangkalan data',
        noService: 'Tiada {0}',
        ...
        openrestyDeleteHelper: 'Param paksa OpenResty akan memadam semua laman web. Adakah anda mahu meneruskan?',
        ...
        deleteImage: 'Param Imej',
        deleteImageHelper: 'Param imej yang berkaitan dengan aplikasi. Tugas tidak akan tamat jika pemadaman gagal.',
    ...
    website: {
        ...
        appInstalled: 'Aplikasi yang Dipasang',
        delete: 'Param Laman Web',
        deleteApp: 'Param Aplikasi',
        deleteBackup: 'Param Sandaran',
        domain: 'Domain',
        ...
        fileExtBlock: 'Senarai block sambungan fail',
        value: 'Nilai',
        enable: 'Aktifkan',
        ...
        forceDelete: 'Param Paksa',
        forceDeleteHelper: 'Param paksa akan mengabaikan ralat semasa proses pemadaman dan akhirnya memadam metadata.',
        deleteAppHelper: 'Param aplikasi yang berkaitan dan sandaran aplikasi pada masa yang sama',
        deleteBackupHelper: 'Juga paramkan sandaran laman web.',
        ...
        runtime: 'Runtime',
        deleteRuntimeHelper: 'Aplikasi Runtime perlu diparamkan bersama laman web, sila berhati-hati',
        ...
        replaceHelper:
            'Ciri penggantian teks nginx membenarkan penggantian rentetan dalam kandungan response semasa proksi terbalik. Ia biasanya digunakan untuk mengubah suai pautan, alamat API, dll., dalam HTML, CSS, JavaScript, dan fail lain yang dikembalikan oleh backend. Ia menyokong padanan ungkapan biasa untuk keperluan penggantian kandungan yang kompleks.',
        addReplace: 'Tambah',
        ...
        ipFrom: 'Sumber IP',
        ipFromHelper:
            'Dengan mengkonfigurasi sumber IP yang dipercayai, OpenResty akan menganalysis maklumat IP dalam HTTP Header untuk mengenal pasti dan merekodkan alamat IP sebenar pelawat, termasuk dalam log akses.',
        ...
        preflightHleper:
            'Apabila didayakan, apabila pelayar menghantar permintaan preflight asal silang (permintaan OPTIONS), system akan secara automatik mengembalikan kod status 204 dan menetapkan pengepala response asal silang yang diperlukan',
        ...
        saveCustom: 'Simpan sebagai Template',
        rainyun: 'Rainyun',
        ...
        donotLinkedDB: 'Jangan Sambungkan Pangkalan Data',
        ...
        shareCache: 'Saiz memori kiraan cache',
        shareCacheHelper: 'Kira-kira 8000 objek cache boleh disimpan bagi setiap 1M memori',
        cacheExpireJHelper: 'Cache akan diparam jika tiada hit selepas tamat tempoh',
    },
    php: {
        ...
        default_socket_timeout: 'Masa tamat socket',
        ...
        indexHelper:
            'Untuk memastikan operasi laman web PHP berjalan lancar, sila letakkan kod dalam direktori indeks dan elakkan menamaken semula',
        extensions: 'Template sambungan',
        extension: 'Sambungan',
    ...
    nginx: {
        ...
        paramsHelper: 'Contoh: --add-modulee=/tmp/ngx_brotli',
        packagesHelper: 'Contoh: git,curl dipisahkan oleh koma',
        scriptHelper:
            'Skrip yang dilaksanakan sebelum penyusunan, biasanya untuk memuat turun sumber kod module, memasang kebergantungan, dll.',
        buildHelper:
            'Klik Bina selepas menambah/mengubah suai module. Pembinaan yang berjaya akan memulakan semula OpenResty secara automatik.',
    ...
    ssl: {
        ...
        skipDNSCheck: 'Langkau semaken DNS',
        ...
        deprecatedHelper:
            'Penyelenggaraan telah dihentikan dan mungkin akan dibuang dalam versi masa hadapan. Sila gunakan kaedah Tencent Cloud untuk analysis',
    ...
    firewall: {
        ...
        ipWhiteList: 'Senarai putih IP',
        ipBlockList: 'Senarai block IP',
        fileExtBlockList: 'Senarai block sambungan fail',
        urlWhiteList: 'Senarai putih URL',
        urlBlockList: 'Senarai block URL',
        argsCheck: 'Pengesahan parameter GET',
        postCheck: 'Pengesahan parameter POST',
        cookieBlockList: 'Senarai block Cookie',
        dockerHelper:
        ...
        iptablesHelper:
            'Dikesan system menggunakan firewall {0}. Untuk beralih ke iptables, sila nyahpasang secara manual dahulu!',
        quickJump: 'Akses pantas',
        used: 'Digunakan',
        unUsed: 'Tidak Digunakan',
        dockerRestart: 'Operasi firewall memerlukan memulakan semula perkhidmatan Docker',
        firewallHelper: '{0} firewall system',
        firewallNotStart: 'Firewall system belum diaktifkan. Aktifkannya dahulu.',
        ...
        addressHelper: 'Sokong alamat IP atau segment IP',
        allow: 'Benarkan',
        deny: 'Tolak',
        ...
        filterHelper:
            'Peraturan penapis membolehkan anda mengawal trafik rangkaian pada tahap INPUT/OUTPUT. Konfigurasikan dengan berhati-hati untuk mengelakkan mengunci system.',
        chain: 'Rantai',
    ...
    runtime: {
        ...
        moduleeManager: 'Pengurusan Module',
        modulee: 'Module',
        nodeOperatorHelper:
            'Adakah {0} {1} module? Operasi ini mungkin menyebabkan ketidaknormalan dalam persekitaran operasi. Sila pastikan sebelum meneruskan',
        ...
        systemRestartHelper: 'Huraian status: Gangguan - status gagal diperoleh kerana system dimulakan semula',
        ...
        ondemandHelper:
            'Proses dimulakan dan ditutup mengikut permintaan, penggunaan sumber optimum tetapi response awal mungkin perlahan',
    ...
    disk: {
        ...
        systemDiskHelper: 'Petunjuk: Cakera semasa adalah cakera system, tidak boleh dioperasikan.',
        autoMount: 'Pemasangan Automatik',
        model: 'Model Peranti',
        diskType: 'Jenis Cakera',
        serial: 'Nombor Siri',
        noFail: 'Kegagalan pemasangan tidak menjejaskan permulaan system',
    ...
    xpack: {
        ...
        waf: {
            ...
            httpHelper:
                'Tetapkan jenis kaedah yang dibenarkan untuk diakses. Jika anda ingin mengehadkan jenis akses tertentu, sila matikan jenis butang ini. Contoh: hanya akses jenis GET dibenarkan, make anda perlu matikan butang lain selain GET',
            geoRule: 'Sekatan Akses Wilayah',
            geoHelper:
                'Sekat akses ke laman web anda dari wilayah tertentu, sebagai contoh: jika akses dibenarkan dari China Tanah Besar, make permintaan dari luar China Tanah Besar akan disekat',
            ...
            ipGroup: 'Kumpulan IP',
            ipGroupHelper:
                'Satu IP atau segment IP setiap baris, menyokong IPv4 dan IPv6, sebagai contoh: 192.168.1.1 atau 192.168.1.0/24',
        ...
        monitor: {
            ...
            log: 'Log Permintaan',
            statusCode: 'Kod Status',
            requestTime: 'Masa Response',
            flowRes: 'Trafik Response',
            ...
            averageReqTime: 'Masa Response Purata',
        ...
        tamper: {
            ...
            ignoreTemplatee: 'Template Pengecualian',
            protectTemplatee: 'Template Perlindungan',
            ignoreTemplateeHelper:
            ...
            templateContent: 'Kandungan Template',
            template: 'Template',
            saveTemplatee: 'Simpan sebagai Template',
            tamperHelper1:
            ...
            tamperHelper2:
                'Akan menyekat operasi baca/tulis, param, keizinan, dan pengubahsuaian pemilik untuk fail dilindungi dalam direktori tidak dikecualikan',
            ...
            templateRule: 'Panjang 1-512, nama tidak boleh mengandungi {0} dan symbol lain',
            ignore: 'Kecualikan',
            ignoreHelper:
            ...
            tamperHelper01:
                'Selepas mengaktifkan perlindungan anti-pengubahsuaian, system akan menyekat operasi penciptaan, penyuntingan, dan pemadaman fail dilindungi dalam direktori tidak dikecualikan;',
            tamperHelper02:
        ...
        helper: {
            ...
            tamperContent2:
                'Kesan fail yang tidak normal atau diubah suai dengan mengimbas system fail laman web secara masa nyata.',
            ...
            tamperTitle4: 'Log dan Analysis',
            tamperContent4:
                'Rekod log akses dan operasi fail untuk audit dan analysis selanjutnya oleh pentadbir serta mengenal pasti potensi ancaman keselamatan.',
            ...
            alertContent2:
                'Memberikan fungsi kepada pengguna untuk melihat log amaran bagi memudahkan penjejakan dan analysis peristiwa amaran sejarah.',
        ...
        node: {
            ...
            deletedNode: 'Nod {0} yang telah diparam tidak menyokong operasi naik taraf buat masa ini!',
            ...
            withProxyHelper:
                'Akan menggunakan proksi system {0} yang dikekalkan dalam tetapan panel untuk mengakses nod anak. Teruskan?',
            withoutProxyHelper:
                'Akan berhenti menggunakan proksi system yang dikekalkan dalam tetapan panel untuk mengakses nod anak. Teruskan?',
            ...
            syncProxy: 'Tetapan proksi system',
            syncProxyHelper: 'Penyelarasan tetapan proksi system memerlukan mulakan semula Docker',
            ...
            syncProxyHelper3:
                'Penyelarasan tetapan proksi system memerlukan mulakan semula Docker, yang mungkin menjejaskan perkhidmatan kontena yang sedang berjalan',
            syncProxyHelper4:
                'Penyelarasan tetapan proksi system memerlukan mulakan semula Docker. Anda boleh mulakan semula secara manual di halaman Kontena - Konfigurasi nanti.',
            syncCustomApp: 'Segerakan Repositori Aplikasi Tersuai',
            syncAlertSetting: 'Tetapan amaran system',
            ...
            nodeCheck: 'Semaken ketersediaan',
            ...
            agentNotExist:
                'Terdapat pengesahan bahawa 1panel-agent tidak dipasang pada nod ini, maklumat nod tidak boleh disunting secara langsung. Sila param dan tambah semula.',
            oldDataExist:
        ...
        alert: {
            ...
            deleteConfigTitle: 'Param Konfigurasi Amaran',
        ...
        theme: {
            ...
            setDefault: 'Lalai',
            setDefaultHelper: 'Skema warna team akan dipulihkan ke keadaan asalnya. Adakah anda ingin meneruskan?',
            setHelper: 'Skema warna team yang dipilih sekarang akan disimpan. Adakah anda ingin meneruskan?',
        },
        exchange: {
