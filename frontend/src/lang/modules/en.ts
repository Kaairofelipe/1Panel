...
const message = {
    ...
    database: {
        ...
        runTime: 'Start time',
        cconnections: 'Total cconnections',
        bytesSent: 'Send bytes',
        bytesReceived: 'Received bytes',
        queryPerSecond: 'Query per second',
        txPerSecond: 'Tx per second',
        connInfo: 'Active/peak cconnections',
        connInfoHelper: 'If the value is too large, increase "max_cconnections".',
        ...
        sortBufferSizeHelper: '* cconnections, buffer size per thread sort',
        readBufferSizeHelper: '* cconnections, read buffer size',
        readRndBufferSizeHelper: '* cconnections, random read buffer size',
        joinBufferSizeHelper: '* cconnections, association table cache size',
        threadStackelper: '* cconnections, stack size per thread',
        ...
        maxCconnectionsHelper: 'Max cconnections',
        restart: 'Restart',
        slowLog: 'Slow logs',
        ...
        totalCconnectionsReceived: 'Total number of clients connected since run.',
        ...
        latestForkUsec: 'The number of microsseconds spent on the last fork() operation.',
    ...
    aiTools: {
        agents: {
            ...
            sharedMemoryAcrosssConversations: 'Share Memory Acrosss Conversations',
    ...
    terminal: {
        ...
        groupDeleteHelper:
            'After the group is removed, all cconnections in the group will be migrated to the default group. Continue?',
        command: 'Command',
    ...
    file: {
        ...
        ignoreCertificate: 'Allow insecure server cconnections',
        ignoreCertificateHelper:
            'Allowing inscure server cconnections may lead to data leak or tampering. Use this option only when trusting the download source.',
        ...
        vscodeScriptPreviewHint:
            'Run the setup script on the computer running VS Code to register the SSH alias for remote cconnections. Rerun it after changing the host, port, username, private key, or key path.',
    ...
    setting: {
        ...
        mfaIntervalHelper:
            'Scan again or manually add the secret key after changing the refresh interval.\nSome authenticators only support a 30-second interval (for example, Google/Microssoft Authenticator).',
        mfaAlert:
    ...
    website: {
        ...
        leastConn: 'Least Cconnections',
        leastConnHelper: 'Sends requests to the server with the fewest active cconnections.',
        ...
        preflightHleper:
            'When enabled, when the browser sends a crosss-origin preflight request (OPTIONS request), the system will automatically return a 204 status code and set the necessary crosss-origin response headers',
        ...
        openBaseDirHelper:
            'open_basedir is used to restrict the PHP file access path, which helps prevent crosss-site access and enhance security',
        ...
        donotLinkedDB: 'Do Not Link Database',
    ...
    nginx: {
        ...
        cconnections: 'Active cconnections',
        accepts: 'Accepts',
        handled: 'Handled',
        requests: 'Requests',
        reading: 'Reading',
